...
Revision ID: 20cf30d3f618
Revises: 
Create Date: 2026-06-02 18:09:28.296184
...
def upgrade() -> None:
    ...
    sa.Column('pricing_per_hour', sa.Numeric(precision=10, scale=2), nullable=False),
